...
class _SeedPlantingPageState extends State<SeedPlantingPage> {
  ...
  Widget _buildSeedCard(InventoryItem seed, ThemeData theme) {
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.grass, size: 80, color: theme.disabledColor.withOpacity(0.3)),
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(16),
                side: BorderSide(color: theme.disabledColor.withOpacity(0.2)),
              ),
            ),
