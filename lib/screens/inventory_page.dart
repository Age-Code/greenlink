...
class _InventoryPageState extends State<InventoryPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("식물 친구를 위한 작은 도구들이에요", style: theme.textTheme.bodyMedium),
          ),
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.inventory_2_outlined, size: 80, color: theme.colorScheme.secondary),
          const SizedBox(height: 24),
          Text("아직 가진 아이템이 없어요", style: theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          Text("출석과 퀘스트로 아이템을 모아보세요", style: theme.textTheme.bodyMedium),
        ],
      ),
    );
  }
  ...
  Widget _buildItemCard(InventoryItem item, ThemeData theme) {
    ...
    try {
      firstOwnedUserItemId = item.items.firstWhere((i) => i.status == 'OWNED').userItemId;
    } catch (e) {
      // Ignore
    }
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(badgeText, style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: theme.primaryColorDark)),
                        ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildCountColumn("사용 가능", item.usableCount, theme, isHighlight: true),
          ...
          canUse
              ...
              : Center(
                  child: Padding(
                    ...
                    child: Text(disabledText, style: TextStyle(color: theme.disabledColor)),
                  ),
                ),
        ],
      ),
  ...
  Widget _buildCountColumn(String label, int count, ThemeData theme, {bool isHighlight = false}) {
    return Column(
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontSize: 16, 
            color: isHighlight ? theme.primaryColorDark : theme.textTheme.bodyLarge?.color,
          ),
        ),
      ],
    );
